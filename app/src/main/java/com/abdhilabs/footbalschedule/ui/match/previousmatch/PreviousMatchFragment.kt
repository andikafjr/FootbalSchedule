...
class PreviousMatchFragment : Fragment(), AdapterView.OnItemSelectedListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        progress_bar_previous_match.visibility = View.VISIBLE
        viewModel = ViewModelProviders.of(this)[PreviousMatchViewModel::class.java]
    ...
    private fun setupSpinner() {
        ...
        spinner_league_previous_match.adapter = adapterSpinner
        spinner_league_previous_match.onItemSelectedListener = this
    }
    ...
    private fun getData(id: String) {
        viewModel.getData(id).observe(this, Observer { data ->
            viewModel.isLoading.observe(this, Observer {
                progress_bar_previous_match.visibility = if (it) VISIBLE else GONE
            })
